package com.bassitology_admin.uis.activity_chapter_exam_questions;
...
public class ChapterExamQuestionActivity extends BaseActivity {
    private ActivityChapterExamQuestionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_chapter_exam_question);
        getDataFromIntent();
        initView();
    }
    ...
    private void initView() {
        ...
        binding.fab.setOnClickListener(view -> {
            Intent intent = new Intent(this, AddExamChapterQuestionsActivity.class);
    ...
    public void delete(QuestionModel questionModel, int adapterPosition) {
        ...
        sRef.child(Tags.image_chapters_path)
                .child(getUserModel().getId())
