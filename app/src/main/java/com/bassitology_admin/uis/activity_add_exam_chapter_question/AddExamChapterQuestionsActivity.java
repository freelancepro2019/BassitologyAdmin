package com.bassitology_admin.uis.activity_add_exam_chapter_question;
...
public class AddExamChapterQuestionsActivity extends BaseActivity {
    private ActivityAddExamChapterQuestionsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_add_exam_chapter_questions);
        getDataFromIntent();
        initView();
    }
    ...
    private void saveImage() {
        ...
        StorageReference imageRef = sRef.child(Tags.image_chapters_path)
                .child(getUserModel().getId())
                .child(examModel.getChapter_id())
                .child(examModel.getId())
                .child(question_id);
