package com.bassitology_admin.uis.activity_lesson_exam_questions;
...
import com.bassitology_admin.databinding.ActivityLessonExamQuestionsBinding;
...
public class LessonExamQuestionsActivity extends BaseActivity {
    private ActivityLessonExamQuestionsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_lesson_exam_questions);
        getDataFromIntent();
        initView();
    }
    ...
    private void initView() {
        ...
        binding.fab.setOnClickListener(view -> {
            Intent intent = new Intent(this, AddExamLessonQuestionsActivity.class);
    ...
    public void delete(QuestionModel questionModel, int adapterPosition) {
        ...
        sRef.child(Tags.image_lessons_path)
                .child(getUserModel().getId())
                .child(questionModel.getChapter_id())
                .child(questionModel.getLesson_id())
