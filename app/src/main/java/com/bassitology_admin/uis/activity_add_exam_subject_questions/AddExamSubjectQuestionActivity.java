package com.bassitology_admin.uis.activity_add_exam_subject_questions;
...
import com.bassitology_admin.databinding.ActivityAddExamChapterQuestionsBinding;
import com.bassitology_admin.databinding.ActivityAddExamSubjectQuestionBinding;
...
public class AddExamSubjectQuestionActivity extends BaseActivity {
    private ActivityAddExamSubjectQuestionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_add_exam_subject_question);
        getDataFromIntent();
        initView();
    }
    ...
    private void saveImage() {
        ...
        StorageReference imageRef = sRef.child(Tags.image_subject_path)
                .child(getUserModel().getId())
                .child(examModel.getId())
                .child(question_id);
    ...
    private void addQuestion(String question_id, Uri uri, ProgressDialog dialog) {
        DatabaseReference dRef = FirebaseDatabase.getInstance().getReference();
        questionModel.setChapter_id("");
        questionModel.setLesson_id("");
